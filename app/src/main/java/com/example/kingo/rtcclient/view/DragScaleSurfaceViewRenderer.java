...
/**
 * Created by kingo on 2019/7/30.
 */

public class DragScaleSurfaceViewRenderer extends SurfaceViewRenderer implements View.OnTouchListener {
  ...
  protected void initScreenW_H(Context context) {
...
//		screenWidth = getResources().getDisplayMetrics().widthPixels;
	...
	@RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR1)
  public DragScaleSurfaceViewRenderer(Context context) {
		super(context);
		setOnTouchListener(this);
		initScreenW_H(context);
	}

  @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR1)
  public DragScaleSurfaceViewRenderer(Context context, AttributeSet attrs) {
		super(context, attrs);
		setOnTouchListener(this);
		initScreenW_H(context);
	}
